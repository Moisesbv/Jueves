...
void main(void)
{
    ...
    char cad1[50] = ""; /* Correcto. Primero se le asigna un valor a la posición de memoria a la que apunta cad1. Luego podemos modificar el contenido de esta posición de memoria utilizando la función gets. */
    ...
    puts(cad2);
    fgets(cad2, sizeof(cad2), stdin); /* El valor de una cadena (declarada como cadena[longitud]) se puede modificar por medio de lecturas o utilizando funciones de la biblioteca string.h (ejemplo 7.6). */
    puts(cad2);
